...
public class BCCR {
    ...
    /**
     * Obtiene el tipo de cambio de compra del día actual
     * desde el API del BCCR.
     *
     * @return tipo de cambio de compra como número decimal
     * @throws Exception si ocurre un error en la conexión o en el procesamiento de la respuesta
     */
